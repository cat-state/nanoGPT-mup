...
def get_config():
    config = {
        ...
        'mup_width_list': [64],# [64, 128, 256, 512, 1024, 2048],
        'mup_lr_list': [2**(-19), 2**(-17), 2**(-15), 2**(-13), 2**(-11), 2**(-9), 2**(-7)], #[2**(-20), 2**(-18), 2**(-16), 2**(-14), 2**(-12), 2**(-10), 2**(-8), 2**(-6)][2**(-19), 2**(-17), 2**(-15), 2**(-13), 2**(-11), 2**(-9), 2**(-7)],
