...
do
    ...
    mkdir -p supar_examples/coord_check_shakespeare_char/supar/out
    out_dir="supar_examples/coord_check_shakespeare_char/supar/out/width${width}_depth2_sparsity${sparsity}_seed${seed}"
    python train.py \
        --out_dir=$out_dir \
        --eval_interval=1 \
        --log_interval=1 \
